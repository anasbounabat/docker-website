        ...
        <div id="chat-messages" class="flex-1 overflow-y-auto p-6 space-y-5 bg-black/80">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="flex <?php echo e($isOwn ? 'justify-end' : 'justify-start'); ?>">
                    <div class="relative w-full lg:w-3/4 px-4 py-3 rounded-2xl shadow-2xl <?php echo e($isOwn ? 'bg-gradient-to-r from-emerald-600 to-emerald-500 text-white' : 'bg-emerald-500/90 text-white border border-emerald-400/70'); ?>">
                        <!--[if BLOCK]><![endif]--><?php if(!$isOwn): ?>
                            <div class="text-[10px] font-semibold text-emerald-200/80 mb-2 uppercase tracking-[0.4em]">
                                <?php echo e(trim(($message['first_name'] ?? '') . ' ' . ($message['last_name'] ?? $message['name'] ?? '')) ?: 'Utilisateur'); ?>

                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <div class="text-base leading-relaxed break-words"><?php echo e($message['content']); ?></div>
...
<style>
    ...
    ?>
<?php /**PATH /var/www/html/resources/views/livewire/chat.blade.php ENDPATH**/ ?>