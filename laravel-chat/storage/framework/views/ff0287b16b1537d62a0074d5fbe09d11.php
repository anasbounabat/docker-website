...
<body style="font-family: Arial, sans-serif; background:#050505; color:#fff; margin:0;">
    <div style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:40px 20px;">
        <div style="width:100%; max-width:520px; border-radius:28px; background:#111; padding:32px; box-shadow:0 20px 50px rgba(0,0,0,0.7);">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" style="margin-top:32px;">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span style="color:#f66; font-size:0.8rem;"><?php echo e($message); ?></span>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin:24px 0; display:flex; align-items:center; justify-content:space-between; font-size:0.85rem;">
                    ...
                    <a href="<?php echo e(route('register')); ?>" style="color:#0f8;">Créer un compte</a>
                </div>
            ...
            <p style="margin-top:14px; font-size:0.8rem; text-align:center; color:#999;">Pas encore inscrit ? <a href="<?php echo e(route('register')); ?>" style="color:#0f8;">Inscris-toi</a></p>
        </div>
    </div>
</body>
</html>
